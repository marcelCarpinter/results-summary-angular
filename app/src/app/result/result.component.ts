...
@Component({
  ...
  template: `
    <div class="rounded-result bg-result container-result">
      ...
      <div>
        ...
        <div>
          ...
          <div>
            <p class="px-2 description">You scored higher than <span id="percentage">65</span>% of the people who have taken these tests</p>
          </div>
        </div>
      </div>
    </div>
